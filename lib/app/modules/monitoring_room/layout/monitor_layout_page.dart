...
class MonitorLayoutPage extends StatelessWidget {
  MonitorLayoutPage({super.key});
  final controller = Get.put(MonitorLayoutController());
  ...
  SidebarMenuItem(
    ...
    page: Center(
      child: Text('Ini Raw Data', style: TextStyle(fontSize: 30)),
    ),
  ),
  SidebarMenuItem(
    ...
    icon: Icons.settings,
    page: Center(
      child: Text('Ini Pengaturan Aplikasi dan Kalibrasi', style: TextStyle(fontSize: 30)),
    ),
  ),
  SidebarMenuItem(
    title: "Bantuan",
  ...
  SidebarMenuItem(
    ...
    icon: Icons.sync,
    page: Center(
      child: Text('Ini Sinkronisasi data Edge - cloud', style: TextStyle(fontSize: 30)),
    ),
  ),
];
