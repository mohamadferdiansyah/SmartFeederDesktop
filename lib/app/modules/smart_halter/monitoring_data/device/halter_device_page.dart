                    ...
                    rows: List.generate(filteredData.length, (i) {
                      ...
                      return DataRow(
                        cells: [
                          ...
                          // DataCell(Text(d.acceY != null ? '${d.acceY} m/s²' : "-")),
                          // DataCell(Text(d.acceZ != null ? '${d.acceZ} m/s²' : "-")),
                          // DataCell(Text(d.gyroX != null ? '${d.gyroX} °/s' : "-")),
                          // DataCell(Text(d.gyroY != null ? '${d.gyroY} °/s' : "-")),
                          // DataCell(Text(d.gyroZ != null ? '${d.gyroZ} °/s' : "-")),
                          // DataCell(Text(d.magX != null ? '${d.magX} µT' : "-")),
